...
const TodoList = ({ todos, remove, toggle, ClearOut, changeList }) => {

  const List = todos.map((todo) => {

    return (
      <div className="list-group-item row" key={todo.date}>
        <div className="col-md-2" align="center"><input id={todo.id} type="checkbox" onChange={() => { toggle(todo.id) }} checked={todo.status} /></div>
  ...
  return (
    <div className="list">
      <div className="option">
        {/* <div onClick={() => { changeList(1) }}>All</div> */}
